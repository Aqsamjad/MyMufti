...
class CustomUserDefaults {
    ...
    func goToHomeScreen(){
        ...
        guard let vc = storyboard.instantiateViewController(withIdentifier: "SWRevealViewController") as? UINavigationController else {print("no homr nsv");return}
    ...
    func saveLoginData(userLoginData: LoginModel) {
        ...
        UserDefaults.standard.setValue(userLoginData.data?.userID, forKey: UserDefaultKeys.userID.rawValue)
        ...
        UserDefaults.standard.setValue(userLoginData.data?.userName, forKey: UserDefaultKeys.name.rawValue)
        UserDefaults.standard.setValue(userLoginData.data?.image, forKey: UserDefaultKeys.image.rawValue)
        UserDefaults.standard.setValue(userLoginData.data?.dreamInfo, forKey: UserDefaultKeys.dreamInfo.rawValue)
    ...
    func saveSignUpData(userSignUpData: SignUpModel, isSocialLogin: Bool) {
        ...
        UserDefaults.standard.setValue(userSignUpData.data?.userID, forKey: UserDefaultKeys.userID.rawValue)
        ...
        UserDefaults.standard.setValue(userSignUpData.data?.userName, forKey: UserDefaultKeys.name.rawValue)
        UserDefaults.standard.setValue(userSignUpData.data?.image, forKey: UserDefaultKeys.image.rawValue)
        UserDefaults.standard.setValue(userSignUpData.data?.dreamInfo, forKey: UserDefaultKeys.dreamInfo.rawValue)
